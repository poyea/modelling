...
class Extractor:
    ...
    def __init__(self, folder: str = "JHU-CSSE-time-series"):
    ...
    def merge_cities(self, input_loc: str, output_loc: str):
        """Merge cities into countries.

        :param input_loc: CSV location to read from.
        :type input_loc: str
        ...
        :param output_loc: CSV location to output to.
        :type output_loc: str
        """
    ...
    def get_confirmed(self, start_date: str, country: str):
        """Get confirmed time series data from a start date of a country.

        :param start_date: The state date.
        :type start_date: str
        ...
    ...
    def get_recovered(self, start_date: str, country: str):
        """Get recovered time series data from a start date of a country.
    ...
    def get_dead(self, start_date: str, country: str):
        """Get dead time series data from a start date of a country.
